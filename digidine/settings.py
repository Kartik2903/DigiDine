"""
Django settings for digidine project.
...
ALLOWED_HOSTS = ['digidine-m1rl.onrender.com', '.onrender.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'digidine.wsgi.application'

ASGI_APPLICATION = 'digidine.asgi.application'
